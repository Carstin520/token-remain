...
MASTER_ICON="$STATE_DIR/100-excited-stars.png"
...
xcrun swift "$ROOT_DIR/script/refine_token_remain_icons.swift" "$SOURCE_DIR" "$STATE_DIR"
...
echo "Built dynamic states and $APP_ICON"
