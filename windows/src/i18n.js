...
const WINDOWS_MESSAGES = {
  ...
  Auto: { "zh-Hans": "自动", "zh-Hant": "自動", ja: "自動", ko: "자동", es: "Auto", de: "Automatisch" },
  Show: { "zh-Hans": "显示", "zh-Hant": "顯示", ja: "表示", ko: "표시", es: "Mostrar", de: "Anzeigen" },
  Hide: { "zh-Hans": "隐藏", "zh-Hant": "隱藏", ja: "非表示", ko: "숨기기", es: "Ocultar", de: "Ausblenden" },
  "%1$@ is signed out": {
...
const WINDOWS_KEY_MESSAGES = {
  ...
  // These shared keys describe macOS surfaces. Keep the catalog keys, but use
  // Windows-native wording wherever the same controls are rendered here.
  "provider.detect.prompt_message": {
    en: "TokenRemain just detected %1$@ on this PC. Start tracking it now? If you have not signed in yet, it will connect automatically after you do.",
    "zh-Hans": "TokenRemain 刚刚在这台 PC 上检测到 %1$@。现在开始追踪吗？如果尚未登录，登录后会自动接入。",
    "zh-Hant": "TokenRemain 剛剛在這台 PC 上偵測到 %1$@。現在開始追蹤嗎？如果尚未登入，登入後會自動接入。",
    ja: "この PC で %1$@ を検出しました。今すぐ追跡を開始しますか？未ログインの場合は、ログイン後に自動接続されます。",
    ko: "이 PC에서 %1$@을(를) 감지했습니다. 지금 추적할까요? 아직 로그인하지 않았다면 로그인 후 자동으로 연결됩니다.",
    es: "TokenRemain acaba de detectar %1$@ en este PC. ¿Quieres empezar a seguirlo? Si aún no has iniciado sesión, se conectará automáticamente cuando lo hagas.",
    de: "TokenRemain hat gerade %1$@ auf diesem PC erkannt. Jetzt verfolgen? Falls du noch nicht angemeldet bist, wird es danach automatisch verbunden.",
  },
  "settings.model_quotas_hint": {
    en: "Optional pools, grouped by app. Each control only changes what Quick View and the Dashboard cards show.",
    "zh-Hans": "按应用分组的附加额度池；每项控制只影响快速查看与 Dashboard 卡片显示什么。",
    "zh-Hant": "依應用分組的附加額度池；每項控制只影響快速檢視與 Dashboard 卡片顯示什麼。",
    ja: "アプリごとにまとめた追加プールです。各コントロールはクイックビューと Dashboard カードの表示だけを変更します。",
    ko: "앱별로 묶은 추가 풀입니다. 각 컨트롤은 빠른 보기와 Dashboard 카드의 표시만 바꿉니다.",
    es: "Bolsas opcionales agrupadas por aplicación. Cada control solo cambia lo que muestran la vista rápida y las tarjetas del Dashboard.",
    de: "Optionale Kontingente, nach App gruppiert. Jede Auswahl ändert nur die Anzeige in der Schnellansicht und den Dashboard-Karten.",
  },
  "settings.menubar_fable": {
    en: "Show Fable in the Claude quota views",
    "zh-Hans": "在 Claude 额度视图中显示 Fable",
    "zh-Hant": "在 Claude 額度檢視中顯示 Fable",
    ja: "Claude の上限表示に Fable を表示",
    ko: "Claude 한도 보기에 Fable 표시",
    es: "Mostrar Fable en las vistas de cuota de Claude",
    de: "Fable in den Claude-Kontingentansichten anzeigen",
  },
  "settings.menubar_fable_hint": {
    en: "Displays Fable's weekly limit in the Claude quota views.",
    "zh-Hans": "在 Claude 额度视图中显示 Fable 的每周额度。",
    "zh-Hant": "在 Claude 額度檢視中顯示 Fable 的每週額度。",
    ja: "Claude の上限表示に Fable の週間上限を表示します。",
    ko: "Claude 한도 보기에 Fable의 주간 한도를 표시합니다.",
    es: "Muestra el límite semanal de Fable en las vistas de cuota de Claude.",
    de: "Zeigt das Wochenlimit von Fable in den Claude-Kontingentansichten an.",
  },
  "settings.menubar_codex_spark": {
    en: "Show GPT-5.3-Codex-Spark in the Codex quota views",
    "zh-Hans": "在 Codex 额度视图中显示 GPT-5.3-Codex-Spark",
    "zh-Hant": "在 Codex 額度檢視中顯示 GPT-5.3-Codex-Spark",
    ja: "Codex の上限表示に GPT-5.3-Codex-Spark を表示",
    ko: "Codex 한도 보기에 GPT-5.3-Codex-Spark 표시",
    es: "Mostrar GPT-5.3-Codex-Spark en las vistas de cuota de Codex",
    de: "GPT-5.3-Codex-Spark in den Codex-Kontingentansichten anzeigen",
  },
  "settings.menubar_codex_spark_hint": {
    en: "Displays the model-specific weekly limit in the Codex quota views.",
    "zh-Hans": "在 Codex 额度视图中显示该模型的每周额度。",
    "zh-Hant": "在 Codex 額度檢視中顯示此模型的每週額度。",
    ja: "Codex の上限表示にモデル固有の週間上限を表示します。",
    ko: "Codex 한도 보기에 모델별 주간 한도를 표시합니다.",
    es: "Muestra el límite semanal específico del modelo en las vistas de cuota de Codex.",
    de: "Zeigt das modellspezifische Wochenlimit in den Codex-Kontingentansichten an.",
  },
