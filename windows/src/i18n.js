...
const WINDOWS_MESSAGES = {
  ...
  "Lowest remaining %1$@. Claude %2$@, Codex %3$@.": { "zh-Hans": "最低剩余 %1$@。Claude %2$@，Codex %3$@。", "zh-Hant": "最低剩餘 %1$@。Claude %2$@，Codex %3$@。", ja: "最小残量 %1$@。Claude %2$@、Codex %3$@。", ko: "최저 잔여량 %1$@. Claude %2$@, Codex %3$@.", es: "Mínimo restante: %1$@. Claude %2$@, Codex %3$@.", de: "Niedrigster Restwert %1$@. Claude %2$@, Codex %3$@." },
