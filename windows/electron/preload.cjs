...
contextBridge.exposeInMainWorld("tokenRemain", {
  ...
  setShowFableQuota: (value) => ipcRenderer.invoke("settings:set-fable-quota", value),
  setShowCodexSparkQuota: (value) => ipcRenderer.invoke("settings:set-codex-spark-quota", value),
  setShowAntigravityThirdPartyQuota: (value) => ipcRenderer.invoke("settings:set-antigravity-third-party-quota", value),
