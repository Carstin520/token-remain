...
![Latest](https://img.shields.io/badge/latest-v1.2.4-22D3EE)

**1.2 release `v1.2.4`** (build 18, Universal Mac Release build)
...
- **Version** — `v1.2.4` (build 18), the Universal Mac Release build.
