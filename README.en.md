...
![Latest](https://img.shields.io/badge/latest-v1.1.5-22D3EE)

**Latest version `v1.1.5`** (build 7, Apple notarized and stapled)
...
- **Version** — `v1.1.5` (build 7). Both the app and the DMG are Apple notarized, stapled and Gatekeeper-accepted.
