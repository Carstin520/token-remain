...
> The menu-bar entry is always available; Settings can show or hide the Dashboard's Dock icon. Every percentage and progress bar represents **remaining** quota.
