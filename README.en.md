...
![Latest](https://img.shields.io/badge/latest-v1.1.2-22D3EE)

**Latest version `v1.1.2`** (build 4, Apple notarized and stapled)
...
- **Version** — `v1.1.2` (build 4). Both the app and the DMG are Apple notarized, stapled and Gatekeeper-accepted.
